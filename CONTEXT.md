...
> Dernière mise à jour : 27 juillet 2026 — Phase 0, étapes 1 à 4 (fondations + multi-tenant, menu, QR + commande client, dashboard temps réel) implémentées, décisions d'architecture consignées en §12
...
Reste à faire dans la Phase 0 : Stripe (abonnement + essai gratuit).
