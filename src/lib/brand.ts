// Renamed from mbQr/RanoumaQr to Tavolino (see CONTEXT.md §12.34). Still not
// run through the trademark/domain/app-store checks §2 lists as mandatory
// before real engagement -- do that before this ships publicly.
export const APP_NAME = "Tavolino";
